-- Generated by PingCap Dumpling
-- version 5.2.4
-- https://github.com/pingcap/dumpling
--
-- Host: 127.0.0.1:4000
-- Date: 2024-06-09 01:32:24
-- Server version: 7.5.0
...
CREATE TABLE IF NOT EXISTS `activetimestamp` (
  ...
  PRIMARY KEY (`uid`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户上次推送时间戳表';
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Q群关注动态推送配置表';
...
CREATE TABLE IF NOT EXISTS `concernstate` (
  ...
  PRIMARY KEY (`group_id`,`uid`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Q群关注对照表';
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='存放该群的某些命令的启用与禁用';
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='记录处于mute状态下的群';
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='赋予群成员本群机器人管理员权限表';
...
CREATE TABLE IF NOT EXISTS `groupsilence` (
  `group_id` bigint NOT NULL COMMENT '群号',
  PRIMARY KEY (`group_id`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='记录处于silence状态下的群';
...
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='存放主播的直播状态';
...
CREATE TABLE IF NOT EXISTS `mode` (
  ...
  PRIMARY KEY (`mode`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='机器人模式表';
...
CREATE TABLE IF NOT EXISTS `permission` (
  ...
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='权限和命令赋予表';
...
CREATE TABLE IF NOT EXISTS `score` (
  ...
  PRIMARY KEY (`group_id`,`qq_id`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='群成员签到积分表';
...
CREATE TABLE IF NOT EXISTS `uidfirsttimestamp` (
  ...
  PRIMARY KEY (`uid`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户首次推送时间戳表';
...
CREATE TABLE `userinfo` (
  ...
  PRIMARY KEY (`uid`,`mid`)
) DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='关注的主播信息表'
